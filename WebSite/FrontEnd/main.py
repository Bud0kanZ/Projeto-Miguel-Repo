...
def mapa():
    ...
    {"coords": [-23.550520, -46.633308], 
     "description": "<h3 style='font-size: 1.5em; font-weight: bold;'>Academia para tênis de mesa</h3><p>Email: exemplo@academia.com</p><p>Contato: (11) 1234-5678</p>"},
    {"coords": [-22.906847, -43.172896], 
     "description": "<h3 style='font-size: 1.5em; font-weight: bold;'>Ginásio de Judô</h3><p>Email: judo@ginasio.com</p><p>Contato: (21) 9876-5432</p>"}]
